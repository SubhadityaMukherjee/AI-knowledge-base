...
- Lazy learning
- All encountered examples are stored in memory in a multi-dimensional array, positioned according to relevant [features](Features.qmd)
...
- Because examplars are represented by their [features](Features.qmd) even novel forms can be classified
