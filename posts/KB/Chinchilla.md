...
- optimal model size and number of tokens for training a [transformer](Transformer.md.md) [language](language.md.md) model under a given compute budget
...
- significantly outperforms Gopher (280B), [GPT](GPT.md.md)-3 (175B), Jurassic-1 (178B), and Megatron-Turing NLG (530B) on a large range of downstream evaluation tasks
