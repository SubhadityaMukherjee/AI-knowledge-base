...
# Wickelphones
- Pro: capture just enough info about the context that determines irregular past-tense [verb](Verb.qmd) forms ense verbs, e.g.sing -sang, ring -rang
- 1 wickelphone = 1 input unit and 1 output unit, connection matrix of 42875 * 42875!!
- Instead, reduce wickelphones to wickelfeatures (1210), where each wickelphone becomes 16 [features](Features.qmd)
- Verbs with same stem and [past tense](past%20tense.qmd)
...
- No distinction between tokens and types, each [verb](Verb.qmd) simply included once
