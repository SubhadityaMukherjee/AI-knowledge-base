...
# [[Attention.md|Attention]] Alignment
- If there are sequences $x, y$
	- Encoder is any [[Recurrent.md|Recurrent]] with a forward state $$\overrightarrow h^{T}$$ and $$\overleftarrow h^{T}$$ for backward
