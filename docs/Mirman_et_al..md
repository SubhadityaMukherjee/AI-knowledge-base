...
- We aren't just sensitive to frequency: we are sensitive to actual [transitional probabilities](Transitional_probabilities.md)
- SRNs with very simple assumptions model non-adjacent learning and [transitional probabilities](Transitional_probabilities.md)
