...
- simple [Self Supervised](Self%20Supervised.qmd)
- [ImageNet](ImageNet.qmd) and in [Transfer Learning](Transfer%20Learning.qmd) that an [Auto Encoders](Auto%20Encoders.qmd) —- a simple self-supervised method similar to techniques in NLP – provides scalable benefits
...
- But decomposing the image into patches (like [Vision Transformer](Vision%20Transformer.qmd) reduces the quadratic computation cost of transformers compared to operating at the pixel level
