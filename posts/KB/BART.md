...
- generalizing BERT (due to the bidirectional encoder), [[GPT.md|GPT]] (with the left-to-right decoder),
...
- With [[GPT.md|GPT]], tokens are predicted auto-regressively (generation of a new token is conditioned on the prior tokens), meaning [[GPT.md|GPT]] can be used for generation.
...
- matches the performance of [[RoBERTa.md|RoBERTa]] with comparable training resource
- [[GLUE.md|GLUE]]
- [[SQuAD.md|SQuAD]]
