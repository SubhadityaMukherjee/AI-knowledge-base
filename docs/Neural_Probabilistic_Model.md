...
- learning the joint [probability](Probability.md) function of sequences of words in a language was intrinsically difficult because of the [curse of dimensionality](Curse_Of_Dimensionality.md)
