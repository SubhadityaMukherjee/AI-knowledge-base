...
- compress these models, [knowledge distillation](Knowledge%20Distillation.qmd)
...
- [Bayesian](Bayesian.qmd) Optimization to conduct multi-objective Neural Architecture Search for selecting student model architectures
- proposed search comprehensively considers both prediction accuracy and serving latency on target hardware
- TPUv4i
- MobileBERT
- [GLUE](GLUE.qmd)
- higher than BERT_BASE, DistillBERT, [TinyBERT](TinyBERT.qmd), NAS-BERT, and MobileBERT
