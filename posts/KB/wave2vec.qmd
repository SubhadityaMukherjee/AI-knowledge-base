...
- first application of unsupervised pre-training to [speech recognition](speech recognition.qmd) using a fully convolutional model that learns representations of raw, unlabeled audio
