...
- [Effects of Contextual Cues on Inferring and Remembering Meanings of New Word](Effects%20of%20Contextual%20Cues%20on%20Inferring%20and%20Remembering%20Meanings%20of%20New%20Word.qmd)
- [SlimStampen](SlimStampen.qmd)
- [The Behavior of Tutoring Systems](The%20Behavior%20of%20Tutoring%20Systems.qmd)
- [The Effect of Three Consecutive Context Sentences on EFL Vocabulary-Learning](The Effect of Three Consecutive Context Sentences on EFL Vocabulary-Learning.qmd)
- [Second Language Vocabulary Learning , The role of context  versus translation](Second Language Vocabulary Learning , The role of context  versus translation.qmd)
- [Learning L2 German Vocabulary Through Reading](Learning L2 German Vocabulary Through Reading.qmd)
...
## Concept
- Outlines the general concept of our system, meaning how we tried to adjust and improve the [slimstampen](slimstampen.qmd) system, and any additional improvements we made to the system.

### Main Idea
- The main idea we have for this project is to improve the [SlimStampen](SlimStampen.qmd) system by presenting vocabulary in context. The way we would like to do this, is by presenting users with the word they need to learn in a sentence. As the learner gets better, the system will increase the difficulty by presenting words without context. If the words are presented out of context and the user makes a mistake, the correct answer will also be shown without context.
...
### Word Order
- Similarly to the set-up of [slimstampen](slimstampen.qmd), we let the system decide which words to show and how based on rate of forgetting. What we changed is that we have different thresholds for when it shows the context, which context it shows, and when it shows just the word.
...
- Training: Participants will try to learn new Dutch words using our adapted [SlimStampen](SlimStampen.qmd) system. This is where the conditions come into play. This segment lasts either 150 trials or until they have seen all words.
...
- Longer term studies (Like [SlimStampen](SlimStampen.qmd))
