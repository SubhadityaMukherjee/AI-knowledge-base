...
- Using MDVM adds an [unsupervised learning](Unsupervised%20Learning.qmd) component to MBL Hoste (2005) because essentially it clusters feature values and uses that information
...
- This seems similar to results with regular [past tense](past%20tense.qmd) forms in English:
...
- Input cues that activate many different outcomes give rise to a highly diverse activation vector, which in turn indicates a high degree of [uncertainty](Uncertainty.qmd) about the intended outcome.
