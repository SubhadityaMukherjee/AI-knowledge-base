...
- [RepVGG: Making Vgg-style ConvNets Great Again](https://arxiv.org/abs/2101.03697)
	- stack of $3\times3$ [Conv](Conv.qmd) and [Relu](Relu.qmd) during inference time
	...
	- higher accuracy and show favorable accuracy-speed trade-off compared to the state-of-the-art models like [EfficientNet](EfficientNet.qmd) and [RegNet](RegNet.qmd)
