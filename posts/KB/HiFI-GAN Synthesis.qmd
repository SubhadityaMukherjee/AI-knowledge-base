...
- generalize to the mel-[spectrogram](Spectrogram.qmd) inversion of unseen speakers and synthesize speech audio comparable to human quality from noisy inputs in an end-to-end setting
