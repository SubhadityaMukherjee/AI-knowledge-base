...
- [Adversarial Loss](Adversarial Loss.qmd)
- $\mathcal{L}_{cyc}$ [Cycle Consistency Loss](Cycle Consistency Loss.qmd)
- Full objective
	- Adversarial Loss + [Cycle Consistency Loss](Cycle Consistency Loss.qmd)
...
- two stride-2 convolutions, several residual blocks, and two fractionally [strided](strided.qmd) convolutions with stride $\frac{1}{2}$
- [Instance Normalization](Instance Normalization.qmd)
...
- Photo Generation from Painting
	...
	- [Identity Loss](Identity Loss.qmd)
...
The discriminator models use [PatchGAN](PatchGAN.qmd), as described by [Phillip Isola](http://web.mit.edu/phillipi/), et al. in their 2016 paper titled “[Image-to-Image Translation with Conditional Adversarial Networks](https://arxiv.org/abs/1611.07004).”
