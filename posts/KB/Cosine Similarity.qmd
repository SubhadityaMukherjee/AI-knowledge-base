...
# Cosine Similarity
- [Lp Regularization](Lp%20Regularization.qmd) l2norm aka p = 2
...
- [Cosine Distance](Cosine Distance.qmd)
...
- If you take a [recommender system](Recommender%20System.qmd), for example, then the cosine similarity does not take into account the difference in rating scale between different users
