...
- Random image [cropping](cropping.qmd) and patching
- [cropping](cropping.qmd) four regions from randomly sampled images and augmenting them to create a new image.
