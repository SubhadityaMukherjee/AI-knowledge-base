...
- which yields the lowerst misclassification rate or highest [Probability](Probability.qmd) of correct classification
- $f_{i}$ be the [PDF](PDF.qmd) for [Class Conditional distribution](Class%20Conditional%20distribution.qmd)
- [Probability](Probability.qmd) of obtaining a correct classification for $R_{i}$ is $$\Sigma_{i=1}^{k}P(X \in R_{i}, Y = c_{i})$$
...
- Algo learns estimates of the [Class Conditional distribution](Class%20Conditional%20distribution.qmd) and class probabilities aka priors
