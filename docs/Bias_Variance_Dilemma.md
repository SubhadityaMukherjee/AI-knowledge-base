...
- Tune on [Emperical_Risk](Emperical_Risk.md) instead using [Optimizers](Optimizers.md)
...
- [Quadratic_Loss](Quadratic_Loss.md) (risk) is minimized by the function $$\Delta(x) = E_{Y|X=x}[Y]$$
...
## [Tuning_Model_Flexibility](Tuning_Model_Flexibility.md)
