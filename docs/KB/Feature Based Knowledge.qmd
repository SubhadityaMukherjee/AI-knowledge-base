...
- To match the semantics between teacher and stu- dent, Chen et al. (2021) proposed cross-layer knowledge distillation, which adaptively assigns proper teacher layers for each student layer via [attention](Attention.qmd) allocation.
...
- [Distillation Schemes](Distillation%20Schemes.qmd)
- [Teacher Student Architecture](Teacher%20Student%20Architecture.qmd)
- [Distillation Algorithms](Distillation%20Algorithms.qmd)
- [Applications of Knowledge Distillation](Applications%20of%20Knowledge%20Distillation.qmd)
