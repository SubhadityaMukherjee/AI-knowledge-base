...
- A naive solution to oversampling with Data Augmentation would be a simple random oversampling with small [[geometric transformations.md|geometric transformations]] such as a 30° rotation
