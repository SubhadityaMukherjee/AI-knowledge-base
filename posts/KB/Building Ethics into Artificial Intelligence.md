...
## Types
- [Consequentialist ethics](Consequentialist ethics.md)
- [Utilitarian ethics](Utilitarian ethics.md)
- [Deontological ethics](Deontological ethics.md)
- [Virtue ethics](Virtue ethics.md)
- [Ethical dilemmas](Ethical dilemmas.md)

## Exploring Ethical Dilemmas
- explore the ethical dilemmas in the target application scenarios [Anderson and Anderson, 2014]
- [GenEth](GenEth.md)
- [Moral Machine project](Moral Machine project.md)
...
- Such rules often involve protected values (a.k.a. [sacred values](sacred values.md))
- [MoralDM](MoralDM.md)
- [Belief-Desire-Intention](Belief-Desire-Intention.md)
- [blind ethical judgement](blind ethical judgement.md)
- [partially informed ethical judgement](partially informed ethical judgement.md)
- [fully informed ethical judgement](fully informed ethical judgement.md)
- [Moral decision making frameworks for artificial intelligence](Moral decision making frameworks for artificial intelligence.md)
- [Preferences and ethical principles in decision making](Preferences and ethical principles in decision making.md)
- [A declarative modular framework for representing and applying ethical principles.](A declarative modular framework for representing and applying ethical principles..md)
- [A low-cost ethics shaping approach for designing reinforcement learning agents](A low-cost ethics shaping approach for designing reinforcement learning agents.md)
- [Even angels need the rules AI, roboethics, and the law](Even angels need the rules AI, roboethics, and the law.md)
- [Norms as a basis for governing sociotechnical systems](Norms as a basis for governing sociotechnical systems.md)
- [Embedding ethical principles in collective decision support systems](Embedding ethical principles in collective decision support systems.md)
...
- [trolley scenario](trolley scenario.md)
...
- [Coping Theory](Coping Theory.md)
