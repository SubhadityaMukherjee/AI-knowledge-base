...
# Attentive [CutMix](CutMix.qmd)
- @walawalkarAttentiveCutMixEnhanced2020
- builds up on [CutMix](CutMix.qmd) .
- Instead of random pasting, it identifies attentive patches for [cutout](cutout.qmd) and pastes them at the same location in the other image.
