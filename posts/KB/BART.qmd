...
- [denoising autoencoder](Denoising%20Autoencoder.qmd)
...
- generalizing BERT (due to the bidirectional encoder), [GPT](GPT.qmd) (with the left-to-right decoder),
...
- With [GPT](GPT.qmd), tokens are predicted auto-regressively (generation of a new token is conditioned on the prior tokens), meaning [GPT](GPT.qmd) can be used for generation.
...
- matches the performance of [RoBERTa](RoBERTa.qmd) with comparable training resource
- [GLUE](GLUE.qmd)
- [SQuAD](SQuAD.qmd)
