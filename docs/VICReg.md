...
- triple objective: learning invariance to different views with a invariance term, avoiding collapse of the representations with a variance preservation term, and maximizing the information content of the representation with a [covariance](Covariance.md) regularization term
- [Bias Vs Variance](Bias%20Vs%20Variance)
- combines the variance term with a decorrelation mechanism based on redundancy reduction and [covariance](Covariance.md) regularization
