...
- [[Le Net]]
- ![[assets/Pasted image 20220711201721.png]]
- ![[assets/Pasted image 20220711201740.png]]
- ![[assets/Pasted image 20220711201745.png]]
- ![[assets/Pasted image 20220711201750.png]]
- ![[assets/Pasted image 20220711201754.png]]
- ![[assets/Pasted image 20220711201758.png]]
- ![[assets/Pasted image 20220711201804.png]]
- One of the challenges of neural networks is understanding what exactly goes on at each layer
- We know that after training, each layer progressively extracts higher and higher-level [[Features|features]] of the image, until the final layer essentially makes a decision on what the image shows
- For example, the first layer maybe looks for edges or corners
- Intermediate [[Layers|layers]] interpret the basic [[Features|features]] to look for overall shapes or components, like a door or a leaf
- The final few [[Layers|layers]] assemble those into complete interpretations—these neurons activate in response to very complex things such as entire buildings or [[Trees|trees]].
...
- But how do you check that the network has correctly learned the right [[Features|features]]? It can help to visualize the network’s representation of a fork.
...
- If we choose higher-level [[Layers|layers]], which identify more sophisticated [[Features|features]] in images, complex [[Features|features]] or even whole objects tend to emerge
...
- But because the data is stored at such a high abstraction, the results are an interesting remix of these learned [[Features|features]].
- Of course, we can do more than cloud watching with this technique
- We can apply it to any kind of image
- The results vary quite a bit with the kind of image, because the [[Features|features]] that are entered bias the network towards certain interpretations
- For example, horizon lines tend to get filled with towers and pagodas
- Rocks and [[Trees|trees]] turn into buildings
