...
- examine hidden unit activation pattern for each word measure distance between each pattern and every other pattern ([Euclidean distance](Euclidean_Distance.md))
...
- [Basic_RNN_Architectures](Basic_RNN_Architectures.md) can find these
