...
- Minimization problem $$(w,b) = argmin_{w^{\ast} , b^{\ast}} \Sigma^N_{i-1}(w^{\ast}x_{i} +b ^{\ast} - y_{i})^2$$
	- [Affine Function](Affine%20Function.qmd)
...
- [Window Based Regression](Window%20Based%20Regression.qmd)
...
- Loss function $$L : \mathbb{R}^k \times \mathbb{R}^k \rightarrow \mathbb{R}^{n \geq 0}$$
	- [Quadratic Loss](Quadratic%20Loss.qmd)
...
- [Left psuedo inverse](Left psuedo inverse.qmd)
