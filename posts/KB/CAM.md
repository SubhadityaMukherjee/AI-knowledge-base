...
- Similar to [Network In Network](Network%20In%20Network.md)
- zeroes out the negative grads during backward pass to provide more visually appealing results
- Uses [Global Average Pooling](Global%20Average%20Pooling.md.md)
- ![1!MFqz4qB107yEZUAPrigSEQ](1!MFqz4qB107yEZUAPrigSEQ.png)
