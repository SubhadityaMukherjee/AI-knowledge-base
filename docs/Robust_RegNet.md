...
- [Unsupervised_Learning](Unsupervised_Learning.md)
- Discriminative [Self_Supervised](Self_Supervised.md) learning allows training models on any random group of internet images, and possibly recover salient information that helps differentiate between the images
