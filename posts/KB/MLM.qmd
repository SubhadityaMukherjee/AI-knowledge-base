...
# MLM ([Masked Language Modeling](Masked Language Modeling.qmd))
- [from](https://publish.obsidian.qmd/fabian-groeger/Machine+Learning+%26+Deep+Learning/Deep+Learning/Architectures/Transformers/Masked+LM)
...
- [loss](loss.qmd) function only considers the predictions of the masked words, ignores non-masked ones
...
- additions to standard architecture:
    ...
    - calculating probability of each word in the vocabulary using [Softmax](Softmax.qmd)
