...
- unsupervised spoken unit discovery coupled with a dual-tower transformer architecture with cross-[attention](Attention.md) trained on 2000 hours of two-channel raw conversational audio [Fisher Spanish-English](Fisher%20Spanish-English.md) without any text or labels
