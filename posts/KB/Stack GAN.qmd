...
## Architecture
- ![1AB51847-C4BA-4F4A-A2AD-8E270B789B8E.webp](1AB51847-C4BA-4F4A-A2AD-8E270B789B8E.webp.qmd)
...
* [regularization](regularization.qmd) term to the objective of the generator during training $$D_{KL}(\mathcal{N}(\mu(\varphi_{t}), \Sigma(\varphi_{t})) || \mathcal{N}(0,I))$$
* [KL Divergence](KL Divergence.qmd) between the standard Gaussian distribution and the conditioning Gaussian distribution
...
* λ is a [regularization](regularization.qmd) parameter that balances the two terms
...
* Stage-I result s0 generated by Stage-I GAN is fed into several [downsampling](downsampling.qmd) blocks (i.e., encoder) until it has a spatial size of Mg × Mg
