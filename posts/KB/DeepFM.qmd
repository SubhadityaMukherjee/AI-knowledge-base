...
- DeepFM can be trained end-to-end with a shared input to its “wide” and “deep” parts, with no need of feature engineering besides raw [features](Features.qmd).
- 1) it does not need any pre-training; 2) it learns both high- and low-order feature interactions; 3) it introduces a sharing strategy of feature [embedding](Embedding.qmd) to avoid feature engineering
- combines the power of factorization machines for recommendation and deep learning for [feature learning](Feature%20Learning.qmd) in a new neural network architecture
- Criteo
