...
- Notice that there is a one-to-one relationship between the step, the [Learning_Event](Learning_Event.md) and the [Knowledge_Component](Knowledge_Component.md). This is a major contributor to the simplicity of Steve's analysis.
