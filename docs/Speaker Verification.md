...
- stacked filterbank [[Features|features]] as input
- During speaker enrollment, the trained DNN is used to extract speaker-specific [[Features|features]]/embeddings by averaging the activations from the last hidden layer (called deep-vectors or “d-vectors” for short), which is taken as the speaker model
