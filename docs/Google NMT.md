...
- [Google’s Neural Machine Translation System: Bridging the Gap Between Human and Machine Translation](https://arxiv.org/abs/1609.08144)
	- deep [Long Short Term Memory (LSTM)](Long%20Short%20Term%20Memory%20(LSTM).md) network with 8 encoder and 8 decoder layers using [attention](Attention.md) and residual connections
