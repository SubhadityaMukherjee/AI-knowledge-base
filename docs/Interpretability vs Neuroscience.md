...
- [[rough note) -- colah's blog](rough note|Interpretability vs Neuroscience (rough note) -- colah's blog]]%20--%20colah's%20blog)
...
- A major undertaking in neuroscience is the attempt to access the [[Connectome|connectome]]
...
- weight-tying,
- [[Force|force]] many neurons to have the same weights
...
- one of the thorniest issues in understanding neurons in artificial networks is separating [[Correlation|correlation]] from causation.
...
- It seems hard to exclude the possibility that the resulting stimulus might have content which causes the artificial neurons predicting the [[Biological Neuron|biological neuron]] to fire more, but aren't causally necessary for the [[Biological Neuron|biological neuron]] to fire.

## Interventions, Ablations, and Edits
- [[Optogenetics]] has been a major methodological advance for neuroscience in allowing neuroscientists to temporarily ablate neurons, or to [[Force|force]] them to activate.
