...
# Sentiment Neuron
- Linear model + L1 [Lp_Regularization](Lp_Regularization.md)
- Uses very few learned units
- Single sentiment neuron that predicts the sentiment value
- ![im](images/Pasted%20image%2020220425233333.png)
- Can be useful for [Unsupervised_Learning](Unsupervised_Learning.md)
