...
- comparable performance to [GPT](GPT.qmd)-3 and Jurassic-1 on the Pile, despite using 25x fewer parameters
- frozen BERT retriever, a differentiable encoder and a chunked cross-[attention](Attention.qmd) mechanism to predict tokens based on an order of magnitude more data than what is typically consumed during training
- Wikitext103
- Pile
