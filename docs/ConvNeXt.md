...
- [A ConvNet for the 2020s](https://arxiv.org/abs/2201.03545)
	- modifying a standard [Res_Net](Res_Net.md) , following design choices closely inspired by [Vision_Transformer](Vision_Transformer.md)
	...
	- hierarchical Transformers (e.g., [Swin_Transformer](Swin_Transformer.md) ) that reintroduced several [Conv](Conv.md) priors, making Transformers practically viable as a generic vision backbone
	...
	- extending the number of epochs, using [AdamW](AdamW) optimizer, Stochastic Depth, [Label_Smoothing](Label_Smoothing.md)
	...
	- [Depthwise_Separable](Depthwise_Separable.md) , which are interestingly similar to self-[Attention](Attention.md) as they work on a per-channel basis
	...
	- [GELU](GELU.md) instead of [Relu](Relu.md) , a single activation for each block (the original [Transformer](Transformer.md) module has just one activation after the MLP), fewer normalization [Layers](Layers.md), [Batch_Normalization](Batch_Normalization.md) substituted by [Layer_Normalization](Layer_Normalization.md) , and separate [downsampling](Downsampling.md) layer
