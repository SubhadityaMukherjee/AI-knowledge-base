...
- frozen BERT retriever, a differentiable encoder and a chunked cross-[[Attention|attention]] mechanism to predict tokens based on an order of magnitude more data than what is typically consumed during training
- Wikitext103
- Pile
