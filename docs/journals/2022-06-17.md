...
- **01:21** Papers and what they talk about
	- A RESEARCH ON SOCIAL MEDIA ADDICTION AND [DOPAMINE](Dopamine.md) DRIVEN FEEDBACK
		- [Gaming_addiction](Gaming_addiction.md)
	...
	- **01:40** iNTERNET ADDICTION AND FUNCTIONAL BRAIN NETWORKS: TASK-RELATED [FMRI](fMRI.md) STUDY
		...
		- [Default_mode_network](Default_mode_network.md) changes
		...
		- **02:04** How should I take the people? With a quick survery like these people? Choosing different samples?
			...
			- [Functional_correlates](Functional_correlates.md) of Addiction in the [Default_mode_network](Default_mode_network.md) and [Inhibitory_Control_Network](Inhibitory_Control_Network.md)
			- I am still not sure of the task. That is the major question. I do want to test the short term effects of social media. So basically I need some sort of task. What was this [Stroop_Task](Stroop_Task.md) ?
			...
			- hypothesized that [BOLD](BOLD.md) signal changes in the regions of the [Default_mode_network](Default_mode_network.md) and [Inhibitory_Control_Network](Inhibitory_Control_Network.md) are correlated with IA scores.
			- [PIUQ](PIUQ.md)
			...
			- Moreover, we found significant deactivations in these areas during incongruent stimuli for both verbal Stroop and non-verbal Stroop-like tasks. [Brain areas](Brain_Areas.md) in the cerebral cortex with constantly decreasing activity during demanding tasks are considered being part of the DMN
	...
	- **02:36** Li et al. - 2015 - Brain structures and [functional connectivity](Functional_Connectivity.md) assoc
...
- **02:38** So far
	...
	- How
		- Measuring [fMRI](fMRI.md) [BOLD](BOLD.md) response in relation to the regions of the [Default_mode_network](Default_mode_network.md) and [Inhibitory_Control_Network](Inhibitory_Control_Network.md)
