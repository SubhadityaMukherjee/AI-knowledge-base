...
- [CvT: Introducing Convolutions to Vision Transformers](https://arxiv.org/abs/2103.15808)
	- improves [Vision_Transformer](Vision_Transformer.md)
	...
	- [Position_Encoding](Position_Encoding.md) , a crucial component in existing Vision Transformers, can be safely removed in our model
