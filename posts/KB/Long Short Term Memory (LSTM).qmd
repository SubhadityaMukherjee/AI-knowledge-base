...
- Splitting state into parts -> output pred and [feature learning](Feature%20Learning.qmd)
- At the end of the day, these could not handle too long sequences. Therefore -> [Transformer](Transformer.qmd)
