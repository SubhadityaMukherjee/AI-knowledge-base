...
- Learning is related to [attention](Attention.qmd)
- We give more [attention](Attention.qmd) to salient items
- Selective [attention](Attention.qmd) leads to overshadowing
- Two cues presented together jointly predict outcomes
- salience (and then [attention](Attention.qmd)) leads to one cue being strongly associated
...
- even though they co-occur with different [verb](Verb.qmd) forms, these are hard to learn
