...
- much different approach to meta-learning than [Neural Augmentation] or [Smart Augmentation](Neural Augmentation] or [Smart Augmentation.md)
- AutoAugment is a Reinforcement Learning algorithm that searches for an optimal augmentation policy amongst a constrained set of [geometric transformations](geometric transformations.md) with miscellaneous levels of distortions. For example, ‘translateX 20 pixels’ could be one of the transformations in the search space
