...
# Misyak Et Al 2010
- Does the ability to learn statistical [non-adjacent dependencies](Non-adjacent%20dependencies.qmd) correlate with the ability to process [non-adjacent dependencies](Non-adjacent%20dependencies.qmd) in language?
...
- [SRN](SRN.qmd) can capture performance on AGL tasks
