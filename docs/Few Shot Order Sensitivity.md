...
- few-shot prompts suffer from order [[Sensitivity|sensitivity]]
...
- identity performant permutations for prompts using [[Entropy|entropy]]-based statistics over this set, which yields a 13% relative improvement for [[GPT]]-family models across eleven different established text classification tasks
