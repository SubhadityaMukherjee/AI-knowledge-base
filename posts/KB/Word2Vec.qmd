...
- possible to train high quality [word vectors](Word%20Vectors.qmd) using very simple model architectures
- [Skip Gram] or [CBOW](Skip Gram] or [CBOW.qmd)
...
- This simple switch changes the model we need from a neural network, to a logistic regression model – thus it becomes much simpler and much faster to calculate. + [Negative Sampling](Negative Sampling.qmd)
