...
- This was inspired by CAM and [Grad-CAM](Grad-CAM.qmd) and tested the explanator on randomly chosen images from the COCO dataset [91], applied to the pre-trained neural network VGG-16 using the Kullback–Leibler (KL) divergence
