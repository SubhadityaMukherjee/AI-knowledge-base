...
- much different approach to meta-learning than [[Neural Augmentation.md]]
- AutoAugment is a Reinforcement Learning algorithm that searches for an optimal augmentation policy amongst a constrained set of [[geometric transformations.md|geometric transformations]] with miscellaneous levels of distortions. For example, ‘translateX 20 pixels’ could be one of the transformations in the search space
