...
- Manhattan distance seems to work okay for high dim data, it is a measure that is somewhat less intuitive than [euclidean distance](Euclidean_Distance.md), especially when using in high-dimensional data
- more likely to give a higher distance value than [euclidean distance](Euclidean_Distance.md) since it does not the shortest path possible.
