...
- Given a vector of [logits](Logits.md) z as the outputs of the last fully connected layer of a deep model, the [Distillation_Loss](Distillation_Loss.md) for response-based knowledge can be formulated as
