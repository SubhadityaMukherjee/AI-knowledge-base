...
- Both the maximum and the average degrees of concurrency usually increase as the [Parallel Granularity](Parallel%20Granularity.qmd) of tasks becomes smaller (finer)
