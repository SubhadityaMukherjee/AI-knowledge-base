...
- Capsule Networks overcome the problem of [translational invariance](translational invariance.qmd) caused by CNNs.
- Capsule Networks are able to capture better spatial relationship. 
- Capsule Networks uses better [downsampling](downsampling.qmd) methods which do not cause loss of information seen in CNNs.
...
- [Capsule Layer](Capsule Layer.qmd)
- [Primary Capsule](Primary Capsule.qmd)
- [Higher Layer Capsule](Higher Layer Capsule.qmd)

## Loss
- [Max Margin Loss](Max Margin Loss.qmd) 
- [Reconstruction loss](Reconstruction loss.qmd)
