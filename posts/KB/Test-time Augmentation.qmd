...
- Matsunaga et al. also demonstrate the effectiveness of test-time augmentation on skin lesion classification, using [geometric transformations](geometric transformations.qmd) such as rotation, translation, scaling, and [Flipping](Flipping.qmd).
