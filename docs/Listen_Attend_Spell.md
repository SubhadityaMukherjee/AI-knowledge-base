...
- bypass the [conditional independence](Conditional_Independence.md) assumptions of [CTC](CTC.md), and show how they can learn an implicit language model that can generate multiple spelling variants given the same acoustics
...
- [Google_voice_search_task](Google_voice_search_task.md)
