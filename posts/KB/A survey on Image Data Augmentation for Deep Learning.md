...
- [Data Augmentation with Curriculum Learning](Data Augmentation with Curriculum Learning.md)
...
- Samples taken from GANs can be augmented with traditional augmentations such as lighting filters, or even used in neural network augmentation strategies such as [Smart Augmentation] or [Neural Augmentation](Smart Augmentation] or [Neural Augmentation.md) to create even more samples. These samples can be fed into further GANs and dramatically increase the size of the original dataset.
