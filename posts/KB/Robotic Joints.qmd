...
# Robotic Joints
- Joints connect the [manipulator](Manipulator.qmd) links
- A joint normally provides one Controllable Degree of Freedom (CDOF)
- For each CDOF one separate [actuator](Actuator.qmd) is needed
- An endeffector with many (C)DOFs needs a lot of actuators!
- [Rotary Joint](Rotary%20Joint.qmd) , [Prismatic Joint](Prismatic%20Joint.qmd)
