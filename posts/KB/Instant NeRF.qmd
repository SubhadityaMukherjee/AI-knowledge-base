...
- [Neural Radiance Field](Neural%20Radiance%20Field.qmd)
- Neural graphics primitives, parameterized by fully connected neural networks, can be costly to train and evaluate
- rely on task specific [data structures](Data%20Structures.qmd)
...
- small neural network is augmented by a multiresolution hash table of trainable feature vectors whose values are optimized through [Gradient Descent gradients](Gradient%20Descent%20gradients.qmd)
...
- 2D images and their camera poses to reconstruct a volumetric radiance-and-[density](Density.qmd) field that is visualized using ray marching.
- neural volume learns a denoised radiance and [density](Density.qmd) field directly from a volumetric path tracer.
...
- parallelism
- fully-fused [Operator Fusion](Operator%20Fusion.qmd) CUDA kernels with a focus on minimizing wasted bandwidth and compute operations
