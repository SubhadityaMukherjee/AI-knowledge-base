...
- $$E_\theta, D_\theta = argmin_{E_\theta, D\theta}||X-D(E(X))||^2$
	- Learn using [Gradient Descent gradients](Gradient%20Descent%20gradients.qmd)
- Compressed rep of data -> Good for Classification or Regression
- [MSE](MSE.qmd) : Unsupervised

## Difficulties
- dim $\mathscr{F} \lt \mathscr{X}$
	- Cannot learn the identity function
- usages
    - data compression / [dimensionality reduction](dimensionality reduction.qmd)
