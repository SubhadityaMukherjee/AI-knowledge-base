...
# Normalized Inverted [Structural_Similarity_Index](Structural_Similarity_Index.md)
- metric is calculated from [Structural_Similarity_Index](Structural_Similarity_Index.md) by inverting the range and then normalizing it.
