...
- non-[autoregressive](autoregressive.qmd) language model based on continuous diffusions
- substantial departure from the current paradigm of discrete [autoregressive](autoregressive.qmd) generation
