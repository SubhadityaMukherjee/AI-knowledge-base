...
- Constraint loss function and a given [Probability](Probability.md) $\mathcal{D}$
	- Eg: By Loss func [KL Divergence](KL%20Divergence.md) and prob distribution $$L(X) = n^{-1}\Sigma_i||x_i - D(E(\tilde x))||^2 + \lambda \cdot KL(f_i, d)$$
