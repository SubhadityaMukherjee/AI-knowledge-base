...
- [Low-rank factorization](Low-rank%20factorization.qmd)
- [Transferred compact convolutional filters](Transferred%20compact%20convolutional%20filters.qmd)
...
- Knowledge distillation has also been explored for [label smoothing](Label%20Smoothing.qmd), for assessing the accuracy of the teacher and for obtaining a prior for the optimal output layer geometry (Tang et al., 2020).
...
- A vanilla knowledge distillation uses the [logits](Logits.qmd) of a large deep model as the teacher knowledge (Hinton et al., 2015; Kim et al., 2018; Ba and Caruana, 2014; Mirzadeh et al., 2020)
...
- [Response Based Knowledge](Response%20Based%20Knowledge.qmd)
- [Feature Based Knowledge](Feature%20Based%20Knowledge.qmd)
