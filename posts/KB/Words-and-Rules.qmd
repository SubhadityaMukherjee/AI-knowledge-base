...
- Look up past-tense
	...
	- Why symbolic? It uses the abstract '[verb](Verb.qmd)'
	- Rules that refer to these categories are used to guide processing
	- [past tense](past%20tense.qmd)
	- Irregular forms stored in associative memory ([declarative memory](Declarative%20memory.qmd))
	- Symbolic rules produce [past tense](past%20tense.qmd) forms (procedural memory)
	...
	- Time 2: child notices pattern: [verb](Verb.qmd) root+ed = past
	...
	- Time 3: Child realizes that there are irregular and regular forms
		...
		- new and novel verbs will get regular endings in [past tense](past%20tense.qmd) unless exposed to irregular past
...
- [Challenges of Words-and-rules](Challenges%20of%20Words-and-rules.qmd)
