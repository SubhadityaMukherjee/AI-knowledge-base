...
- # Bayesian Rule List
  ```toc
  ```
- [@Interpretable classifiers using rules and Bayesian analysis: Building a better stroke prediction model](@Interpretable%20classifiers%20using%20rules%20and%20Bayesian%20analysis:%20Building%20a%20better%20stroke%20prediction%20model.md)
