...
- As such, the perceived timing of stimuli in an environment where trials are isochronous should exhibit the temporal [regularization](regularization.qmd) effect
