...
- in a “ring” around each positive, by approximating the partition function using samples from a class of conditional [distributions](Distributions.qmd)
...
- transferring [features](Features.qmd) to a variety of new image [distributions](Distributions.qmd) from the meta-dataset collection
