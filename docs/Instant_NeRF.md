...
- [Neural_Radiance_Field](Neural_Radiance_Field.md)
- Neural graphics primitives, parameterized by fully connected neural networks, can be costly to train and evaluate
- rely on task specific [data structures](Data_Structures.md)
...
- small neural network is augmented by a multiresolution hash table of trainable feature vectors whose values are optimized through [Gradient_Descent_gradients](Gradient_Descent_gradients.md)
...
- parallelism
- fully-fused [Operator_Fusion](Operator_Fusion.md) CUDA kernels with a focus on minimizing wasted bandwidth and compute operations
