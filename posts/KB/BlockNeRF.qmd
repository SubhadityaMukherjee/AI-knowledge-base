...
- variant of [Neural Radiance Field](Neural%20Radiance%20Field.qmd)
...
- appearance [Embedding](Embedding.qmd), learned pose refinement, and controllable exposure to each individual NeRF
