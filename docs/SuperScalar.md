...
# SuperScalar
- A superscalar CPU architecture implements [Instruction_level_programming](Instruction_level_programming.md) inside a single processor which allows faster CPU throughput at the same clock rate.
