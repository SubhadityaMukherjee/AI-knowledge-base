...
---
- **09: 55** Day 2 of the [fastai](fastai.md) course. lets see what today brings us.
- [ULMFit](ULMFit.md)
...
- Maybe I will read the [fastai](fastai.md) blog for interesting bits or just code. Probably code.
