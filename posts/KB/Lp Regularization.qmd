...
# Lp [Regularization](Regularization.qmd)
...
- $$L^\ast(\theta) = L(\theta) + \lambda \Sigma_i |\theta_i|^p$$
	...
	- Weight Decay
		...
		- Encourages optimization [trajectory](Trajectory.qmd) perpendicular to isocurves
		- ![im](images/Pasted%20image%2020220306133032.png)
- Tune $$\lambda$$
	- Grid search : log scale
	- Too large : underfit, too small : overfit
	- [Cross Validation](Cross%20Validation.qmd) required
