...
The [../../Xception|Xception](../../Xception|Xception.qmd) model architecture is shown here.
...
The [../../Xception|Xception](../../Xception|Xception.qmd) model's caveat is that it defines the inputs are scaled from the original range of (0,255) to the range of (-1.0, 1.0). We perform this rescaling using the **Rescaling** layer as follows.
