...
- A naive solution to oversampling with Data Augmentation would be a simple random oversampling with small [geometric transformations](geometric%20transformations.md.md) such as a 30° rotation
