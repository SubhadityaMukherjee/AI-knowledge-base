...
- **01:21** Papers and what they talk about
	...
	- **01:40** iNTERNET ADDICTION AND FUNCTIONAL BRAIN NETWORKS: TASK-RELATED [FMRI](../fMRI.md) STUDY
		...
		- [Default mode network](../Default%20mode%20network.md) changes
		...
		- **02:04**  How should I take the people? With a quick survery like these people? Choosing different samples?
			...
			- [Functional correlates](../Functional%20correlates.md) of Addiction in the [Default mode network](../Default%20mode%20network.md) and [Inhibitory Control Network](../Inhibitory%20Control%20Network.md)
			- I am still not sure of the task. That is the major question. I do want to test the short term effects of social media. So basically I need some sort of task. What was this [Stroop Task](../Stroop%20Task.md) ? 
			...
			- hypothesized that [BOLD](../BOLD.md) signal changes in the regions of the [Default mode network](../Default%20mode%20network.md) and [Inhibitory Control Network](../Inhibitory%20Control%20Network.md) are correlated with IA scores.
			- [PIUQ](../PIUQ.md)
	...
	- **02:36** Li et al. - 2015 - Brain structures and [functional connectivity](../Functional%20Connectivity.md) assoc
...
- **02:38** So far 
	...
	- How
		- Measuring [fMRI](../fMRI.md) [BOLD](../BOLD.md) response in relation to the regions of the [Default mode network](../Default%20mode%20network.md) and [Inhibitory Control Network](../Inhibitory%20Control%20Network.md)
