...
- fine-tuned version of [GPT](GPT.qmd)-3 to more accurately answer open-ended questions using a text-based web browser.
...
- fine-tuning [GPT](GPT.qmd)-3 using behavior cloning, and then performing [rejection sampling](Rejection%20Sampling.qmd) against a reward model trained to predict human preferences
