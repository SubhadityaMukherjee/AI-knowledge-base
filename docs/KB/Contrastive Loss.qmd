...
# Contrastive [Loss](loss.qmd)
- Minimize distance between similar inputs [Gradient Descent gradients](Gradient%20Descent%20gradients.qmd), maximize between dissimilar [Gradient Ascent](Gradient%20Ascent.qmd)
- Learn [Embedding](Embedding.qmd)/Feature space using neighbors
