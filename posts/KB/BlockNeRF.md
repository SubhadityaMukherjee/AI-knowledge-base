...
- variant of [Neural Radiance Field](Neural%20Radiance%20Field.md.md)
...
- appearance [Embedding](Embedding.md.md), learned pose refinement, and controllable exposure to each individual NeRF
