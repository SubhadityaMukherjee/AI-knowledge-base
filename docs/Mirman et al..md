...
- Model trained to recognize one of five objects for each of five different two-syllable input patterns of three types 1. words (100% transitional [[Probability|probability]]) 2. partwords (25% [[Probability|probability]] transitions) 3. nonwords (0% transitions)
...
- We aren't just sensitive to frequency: we are sensitive to actual [[Transitional probabilities|transitional probabilities]]
- SRNs with very simple assumptions model non-adjacent learning and [[Transitional probabilities|transitional probabilities]]
...
- concepts are just bundles of [[Features|features]], that together become something
