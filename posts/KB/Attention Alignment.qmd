...
# [Attention](Attention.qmd) Alignment
- If there are sequences $x, y$
	- Encoder is any [Recurrent](Recurrent.qmd) with a forward state $$\overrightarrow h^{T}$$ and $$\overleftarrow h^{T}$$ for backward
...
- Matrix of alignment
	...
	- Final scores calculated with a [Softmax](Softmax.qmd)
