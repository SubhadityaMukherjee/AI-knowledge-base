...
- [GLUE](GLUE.qmd)
- performs comparably to [RoBERTa|[RoBERTa](RoBERTa.qmd)](RoBERTa.qmd) and [XLNet](XLNet.qmd) while using less than 1/4 of their compute and outperforms them when using the same amount of compute.
