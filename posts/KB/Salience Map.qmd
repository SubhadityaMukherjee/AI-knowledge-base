...
### Dencov
- Use [DeconvNet](DeconvNet.qmd)
- Use backprop to compute the gradients of logits wrt input : [Deep Inside Convolutional Networks](Deep Inside Convolutional Networks.qmd)
- [Guided BackProp](Guided BackProp.qmd)
