...
- rely on task specific [[Data Structures|data structures]]
...
- 2D images and their camera poses to reconstruct a volumetric radiance-and-[[Density|density]] field that is visualized using ray marching.
- neural volume learns a denoised radiance and [[Density|density]] field directly from a volumetric path tracer.
