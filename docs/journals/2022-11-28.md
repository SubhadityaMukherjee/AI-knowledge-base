...
date modified: Thursday, December 1st 2022, 11:00:02 am
---
...
- At the end of each trial I stored an estimate of the foreperiod in memory as a number of pulses that the model perceived (so no merging of similar experiences)
