...
- **01:21** Papers and what they talk about
	...
	- **01:40** iNTERNET ADDICTION AND FUNCTIONAL BRAIN NETWORKS: TASK-RELATED FMRI STUDY
		...
		- **02:04**  How should I take the people? With a quick survery like these people? Choosing different samples?
			...
			- Incongruent stimuli induced [BOLD](../BOLD.md) signal changes were found to be negatively correlated with PIUQ
			- Moreover, we found significant deactivations in these areas during incongruent stimuli for both verbal Stroop and non-verbal Stroop-like tasks. Brain areas in the cerebral cortex with constantly decreasing activity during demanding tasks are considered being part of the DMN
