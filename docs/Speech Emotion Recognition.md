...
- nvestigate the usage of GANs for capturing the data [[Manifold|manifold]] when the data is eyes-off, i.e., where they can train networks using the data but cannot copy it from the clients
