...
# Tacotron
- CBHG
	- [Conv](Gated Recurrent Unit (GRU|Gated Recurrent Unit (GRU|[Conv](GRU)](Conv](Gated Recurrent Unit (GRU|Gated Recurrent Unit (GRU|[Conv](GRU).qmd).qmd)

```python
class CBHG_Old(nn.Module):
    """CBHG module: a [recurrent](Recurrent.qmd) neural network composed of:
        - 1-d convolution banks
        - Highway networks + residual connections
        - Bidirectional gated [recurrent](Recurrent.qmd) units
    """
