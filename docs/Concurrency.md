...
- Both the maximum and the average degrees of concurrency usually increase as the [Parallel_Granularity](Parallel_Granularity.md) of tasks becomes smaller (finer)
