...
- either score a pair of sequences (in terms of a conditional [[Probability|probability]]) or generate a target sequence given a source sequence
- jointly trained to maximize the conditional [[Probability|probability]] of a target sequence given a source sequence
