...
- The recent advances in large [language](language.qmd) models (LLMs) have transformed the field of natural [language](language.qmd) processing (NLP)
- From [GPT3](GPT3.qmd) to [PaLM](PaLM.qmd), the state-of-the-art performance on natural [language](language.qmd) tasks is being pushed forward with every new large [language](language.qmd) model
