...
- If error terms $\epsilon$ follows [Normal_Distribution](Normal_Distribution.md) , expected value 0 + constant variance $$AIC = \frac{1}{\eta \sigma^{2}}(RSS + 2p \hat \sigma^2)$$
