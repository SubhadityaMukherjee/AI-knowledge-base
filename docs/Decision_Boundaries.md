...
- $f_{i}$ be the [PDF](PDF.md) for [Class_Conditional_distribution](Class_Conditional_distribution.md)
...
- Algo learns estimates of the [Class_Conditional_distribution](Class_Conditional_distribution.md) and class probabilities aka priors
