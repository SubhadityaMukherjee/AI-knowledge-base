...
- Doctors might use uplift modeling to predict the mortality decrease (causal effect) of a [medical](medical.qmd) procedure (treatment) depending on the age and [medical](medical.qmd) history of a patient (individual).
