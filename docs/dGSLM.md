...
- unsupervised spoken unit discovery coupled with a dual-[tower](Tower.md) [transformer](Transformer.md) architecture with cross-[attention](Attention.md) trained on 2000 hours of two-channel raw conversational audio [Fisher_Spanish-English](Fisher_Spanish-English.md) without any text or labels
