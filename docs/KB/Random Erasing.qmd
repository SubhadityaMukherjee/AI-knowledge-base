...
- deletes contiguous rectangular image regions similar to [cutout](cutout.qmd) with minor differences in region selection procedure.
- Opposite to [cutout](cutout.qmd), where deletion is applied on all the images, here it is performed with a probability of either applying it or not
