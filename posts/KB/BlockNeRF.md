...
- variant of [[Neural Radiance Field.md|Neural Radiance Field]]
...
- appearance [[Embedding.md|Embedding]], learned pose refinement, and controllable exposure to each individual NeRF
