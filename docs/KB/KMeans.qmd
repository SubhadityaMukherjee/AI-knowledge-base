...
- Error quantity does not increase
	- [Intra cluster variance](Intra%20cluster%20variance.qmd)
	- Clusters are bounded by line [Decision Boundaries](Decision%20Boundaries.qmd) and forms a [Voronoi Cell](Voronoi%20Cell.qmd)
