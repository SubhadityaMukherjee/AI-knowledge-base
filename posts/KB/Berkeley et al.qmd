...
- [Single unit recording](Single%20unit%20recording.qmd)
...
- Bands are associated with interpretable [features](Features.qmd)
- [Lesion](Lesion.qmd) studies show bands are essential to solving problem
