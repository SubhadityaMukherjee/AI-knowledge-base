...
- the fixations for all observers were collected and blurred using the [Gaussian filter](Gaussian filter.qmd) with the standard deviation equivalent to 1° in the visual angle
