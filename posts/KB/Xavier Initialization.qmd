...
# Xavier [Initialization](Initialization.qmd)
...
- For [Batch Normalization](Batch%20Normalization.qmd) [Layers](Layers.qmd), $\gamma =1$ and $\beta=0$
- For [Tanh](Tanh.qmd) based activating neural nets
