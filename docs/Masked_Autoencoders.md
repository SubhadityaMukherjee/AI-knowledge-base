...
- simple [Self_Supervised](Self_Supervised.md)
- [ImageNet](ImageNet.md) and in [Transfer_Learning](Transfer_Learning.md) that an [Auto_Encoders](Auto_Encoders.md) —- a simple self-supervised method similar to techniques in NLP – provides scalable benefits
...
- But decomposing the image into patches (like [Vision_Transformer](Vision_Transformer.md) reduces the quadratic computation cost of transformers compared to operating at the pixel level
