...
# Biological Neuron
- ![Pasted image 20220810154324](Pasted%20image%2020220810154324.png)
...
- composed of 
    - cell body
    - [dendrites](Dendrites.md.md): many branching extensions
    - [axon](Axon.md.md): very long extension that splits off at its tip into many branches called synaptic terminals
- composed in a network (e.g. brain) by synaptic terminals of one neuron connected to [dendrites](Dendrites.md.md) of other neurons
...
- Irreplacable
- Requires constant supply of [Glucose](Glucose.md.md)
