...
- compress these models, [knowledge distillation](Knowledge%20Distillation.md.md)
...
- [Bayesian](Bayesian.md.md) Optimization to conduct multi-objective Neural Architecture Search for selecting student model architectures
- proposed search comprehensively considers both prediction accuracy and serving latency on target hardware
- TPUv4i
- MobileBERT
- [GLUE](GLUE.md.md)
- higher than BERT_BASE, DistillBERT, [TinyBERT](TinyBERT.md.md), NAS-BERT, and MobileBERT
