...
- Look up past-tense
	...
	- [past_tense](past_tense.md)
	- Irregular forms stored in associative memory ([declarative memory](Declarative_memory.md))
	- Symbolic rules produce [past_tense](past_tense.md) forms (procedural memory)
	...
	- Time 3: Child realizes that there are irregular and regular forms
		...
		- new and novel verbs will get regular endings in [past_tense](past_tense.md) unless exposed to irregular past
...
- [Challenges_of_Words-and-rules](Challenges_of_Words-and-rules.md)
