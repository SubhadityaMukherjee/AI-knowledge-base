...
- replicate the performance and sizes of the [GPT](GPT.qmd)-3 class of models, while also applying the latest best practices in data curation and training efficiency
- OPT-175B is comparable to [GPT](GPT.qmd)-3, while requiring only 1/7th the carbon footprint to develop
