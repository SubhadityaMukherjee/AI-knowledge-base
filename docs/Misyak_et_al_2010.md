...
# Misyak Et Al 2010
- Does the ability to learn statistical [non-adjacent dependencies](Non-adjacent_dependencies.md) correlate with the ability to process [non-adjacent dependencies](Non-adjacent_dependencies.md) in language?
