...
# Attentive [CutMix](CutMix.md.md)
- @walawalkarAttentiveCutMixEnhanced2020
- builds up on [CutMix](CutMix.md.md) .
- Instead of random pasting, it identifies attentive patches for [cutout](cutout.md.md) and pastes them at the same location in the other image.
