...
- Let us use knowledge for the information possessed by students that determines their behavior on task. Let us also assume that knowledge can be decomposed, and let us use the term [Knowledge_Component](Knowledge_Component.md) for the units into which it is decomposed.
- [Knowledge_Component](Knowledge_Component.md)
- [Learning_Event](Learning_Event.md)
- [Modeling_Transfer](Modeling_Transfer.md)
- [Predicting_Student_learning_Curve](Predicting_Student_learning_Curve.md)
- [Tutor](Tutor.md)
...
- [Mastery_learning](Mastery_learning.md)
...
- [DT_Tutor](DT_Tutor.md)
- [Help_Abuse](Help_Abuse.md)
- [Help_Refusal](Help_Refusal.md)
...
- In AI, this is called the [plan_recognition_problem](plan_recognition_problem.md)
...
- If the step requires only one [Knowledge_Component](Knowledge_Component.md), then a standard hint sequence is Point, Teach and Bottom-out (Hume, Michael, Rovick, & Evens, 1996)
- Pointing hints mention problem conditions that should remind the student of the [Knowledge_Component](Knowledge_Component.md)'s relevance.
- Teaching hints describe the [Knowledge_Component](Knowledge_Component.md) briefly and show how to apply it.
- Bottom-out hints tell the student the step

### ERROR-SPECIFIC FEEDBACK
- The service consists of analyzing an incorrect step in order to determine the incorrect [Learning_Event](Learning_Event.md)(s) that led to it, then giving instruction that is aimed at preventing that incorrect [Learning_Event](Learning_Event.md)(s) from occurring again
...
- [Coarse-grained_assessment](Coarse-grained_assessment.md)
- [Fine_Grained_assesment](Fine_Grained_assesment.md)
...
- Prior probabilities of mastery are not independent. If a student has not mastered a [Knowledge_Component](Knowledge_Component.md) that is taught early in the course, then it is less likely that the student has mastered.
- Knowledge components that appear later.

## Examples of Tutoring Systems
- [Steve](Steve.md)
- [Algebra_Cognitive_Tutor](Algebra_Cognitive_Tutor.md)
- [Andes](Andes.md)
