...
- no need for any [Markov Chain](Markov%20Chain.md.md) or unrolled approximate inference networks during either training or generation of samples
- [Adversarial Learning](Adversarial%20Learning.md.md)
- ![im](Pasted%20image%2020220310210209.png)
- Min Max game $$max_D min_G V(G,D)$$ where $$V(G,D) = \mathbb{E}_{p_{data}(x)}logD(x) + \mathbb{E}_{p_{data}(x)}log(1-D(x))$$
- G : [Gradient Descent gradients](Gradient%20Descent%20gradients.md.md)
- D : [Gradient Ascent](Gradient%20Ascent.md.md)
...
## [Issues](Issues.md.md)
- [Mode Collapse](Mode%20Collapse.md.md)
