...
- Model trained to recognize one of five objects for each of five different two-syllable input patterns of three types 1. words (100% transitional [probability](Probability.qmd)) 2. partwords (25% [probability](Probability.qmd) transitions) 3. nonwords (0% transitions)
...
- [SRN](SRN.qmd) can show how statistical learning supports word learning, showing a link
...
- We aren't just sensitive to frequency: we are sensitive to actual [transitional probabilities](Transitional%20probabilities.qmd)
- SRNs with very simple assumptions model non-adjacent learning and [transitional probabilities](Transitional%20probabilities.qmd)
...
- concepts are just bundles of [features](Features.qmd), that together become something
