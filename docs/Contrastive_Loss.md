...
- Minimize distance between similar inputs [Gradient_Descent_gradients](Gradient_Descent_gradients.md), maximize between dissimilar [Gradient_Ascent](Gradient_Ascent.md)
