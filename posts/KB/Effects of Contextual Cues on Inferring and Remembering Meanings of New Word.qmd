...
- These were group means in terms of: (1) measures of word inference (i.e. inferring the meanings of unfamiliar words); (2) ratings of degrees of difficulty of word inference, and (3) measures of word retention (i.e. [recall](recall.qmd) of the inferred meanings of the target words).
...
- The last task, word retention, was a cued [recall](recall.qmd) of the target words' inferred contextual meanings.
...
- Without adequate bridging information, it would seem next to impossible to infer and [recall](recall.qmd) the contextual meaning of any unfamiliar word.
