...
- Collaborative [filtering](Filtering.qmd) (CF) is a successful approach commonly used by many recommender systems
...
- To address this [sparsity](sparsity.qmd) problem, auxiliary information such as item content information may be utilized
...
- generalizing recent advances in deep learning from i.i.d input to non-i.i.d (CF-based) input and propose a hierarchical [Bayesian](Bayesian.qmd) model called collaborative deep learning (CDL), which jointly performs deep representation learning for the content information and collaborative [filtering](Filtering.qmd) for the ratings (feedback) matrix.
