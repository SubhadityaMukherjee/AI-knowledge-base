...
- Uses [Token Embedding](Token%20Embedding.md.md)
- [Self Supervised](Self%20Supervised.md.md)
- Masked [language](language.md.md) modeling, next sentence prediction
...
- [christianversloot](https://github.com/christianversloot/machine-learning-articles/blob/main/intuitive-introduction-to-bert.md) #[Roam-Highlights](Roam-Highlights)
    - BERT base $\text{BERT}_\text{BASE}$, which has 12 Encoder Segments stacked on top of each other, has 768-dimensional intermediate state, and utilizes 12 [attention](Attention.md.md) heads (with hence 768/12 = 64-dimensional [attention](Attention.md.md) heads).
    - BERT large ($\text{BERT}_\text{LARGE}$), which has 24 Encoder Segments, 1024-dimensional intermediate state, and 16 [attention](Attention.md.md) heads (64-dimensional [attention](Attention.md.md) heads again).
    ...
    - [Masked Language Modeling](Masked%20Language%20Modeling.md.md)
    ...
    - [BooksCorpus](BooksCorpus.md.md)
    - [English Wikipedia](English%20Wikipedia.md.md)
