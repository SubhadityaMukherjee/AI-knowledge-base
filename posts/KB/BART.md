...
- generalizing BERT (due to the bidirectional encoder), [GPT](GPT.md.md) (with the left-to-right decoder),
...
- With [GPT](GPT.md.md), tokens are predicted auto-regressively (generation of a new token is conditioned on the prior tokens), meaning [GPT](GPT.md.md) can be used for generation.
...
- matches the performance of [RoBERTa](RoBERTa.md.md) with comparable training resource
- [GLUE](GLUE.md.md)
- [SQuAD](SQuAD.md.md)
