...
- Learning is related to [attention](Attention.md.md)
- We give more [attention](Attention.md.md) to salient items
- Selective [attention](Attention.md.md) leads to overshadowing
- Two cues presented together jointly predict outcomes
- salience (and then [attention](Attention.md.md)) leads to one cue being strongly associated
...
- even though they co-occur with different [verb](Verb.md.md) forms, these are hard to learn
