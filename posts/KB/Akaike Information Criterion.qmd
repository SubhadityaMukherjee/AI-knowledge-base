...
- If error terms $\epsilon$ follows [Normal Distribution](Normal%20Distribution.qmd) , expected value 0 + constant variance $$AIC = \frac{1}{\eta \sigma^{2}}(RSS + 2p \hat \sigma^2)$$
