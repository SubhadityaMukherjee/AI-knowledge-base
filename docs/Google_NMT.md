...
- [Google’s Neural Machine Translation System: Bridging the Gap Between Human and Machine Translation](https://arxiv.org/abs/1609.08144)
	...
	- low-precision arithmetic during inference computations ([FP16_training](FP16_training.md) ???)
	...
	- [Beam_search](Beam_search.md) technique employs a length-normalization procedure and uses a coverage penalty
