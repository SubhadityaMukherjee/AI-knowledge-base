...
## Related Work
- uses the coefficients of Attention based on Information the basis Maximization (AIM) calculated by the independent component analysis ([ICA](ICA.qmd)) in local image patches
...
- [Saliency using natural statistics](Saliency%20using%20natural%20statistics.qmd)
- [Dynamic visual attention](Dynamic%20visual%20attention.qmd)
- [Adaptive Whitening Saliency](Adaptive%20Whitening%20Saliency.qmd)
- [SAM-ResNet](SAM-ResNet.qmd)
## Components of Readout Net
- The operation attempts to directly minimise the reconstruction error of the input image under a [sparsity](sparsity.qmd) constraint on an over-complete set of feature maps
...
## Datasets
- [Salicon dataset](Salicon%20dataset.qmd)
- [OSIE](OSIE.qmd)
- [PASCAL-S](PASCAL-S.qmd)
- [MIT1003](MIT1003.qmd)
- [MIT300](MIT300.qmd)
## Metrics
- [AUC-Judd](AUC-Judd.qmd)
- [AUC-Borji](AUC-Borji.qmd)
- [Shuffled-AUC](Shuffled-AUC.qmd)
## Conclusions
- strong correlation between image classification accuracy and saliency map estimation accuracy.
