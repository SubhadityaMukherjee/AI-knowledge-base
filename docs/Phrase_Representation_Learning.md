...
- two [recurrent](Recurrent.md) neural networks [Basic_RNN_Architectures](Basic_RNN_Architectures.md) that is together able to learn the mapping from a sequence of an arbitrary length to another sequence, possibly from a different set, of an arbitrary length.
