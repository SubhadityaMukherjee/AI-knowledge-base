...
- Tune on [Emperical Risk](Emperical%20Risk.qmd) instead using [Optimizers](Optimizers.qmd)
- $\mathcal{H}$ is hypothesis space (related to [Fitting](Fitting.qmd)).
...
- [Quadratic Loss](Quadratic%20Loss.qmd) (risk) is minimized by the function $$\Delta(x) = E_{Y|X=x}[Y]$$
...
## [Tuning Model Flexibility](Tuning%20Model%20Flexibility.qmd)
