...
- Typical visual explanation approaches in- clude class activation mapping ([CAM](CAM.qmd)) and [Grad-CAM](Grad-CAM.qmd)
...
- To make an attention map from the bubbles, we use a kernel [density](density.qmd) estimation with multiple bubbles
