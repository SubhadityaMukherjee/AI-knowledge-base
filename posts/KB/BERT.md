...
- Uses [[Token Embedding.md|Token Embedding]]
- [[Self Supervised.md|Self Supervised]]
- Masked [[language.md|language]] modeling, next sentence prediction
- ![[Pasted image 20220307183916.png|im]]
...
- [christianversloot](https://github.com/christianversloot/machine-learning-articles/blob/main/intuitive-introduction-to-bert.md) #[[Roam-Highlights]]
    - BERT base $\text{BERT}_\text{BASE}$, which has 12 Encoder Segments stacked on top of each other, has 768-dimensional intermediate state, and utilizes 12 [[Attention.md|attention]] heads (with hence 768/12 = 64-dimensional [[Attention.md|attention]] heads).
    - BERT large ($\text{BERT}_\text{LARGE}$), which has 24 Encoder Segments, 1024-dimensional intermediate state, and 16 [[Attention.md|attention]] heads (64-dimensional [[Attention.md|attention]] heads again).
    ...
    - [[Masked Language Modeling.md|Masked Language Modeling]]
    ...
    - [[BooksCorpus.md|BooksCorpus]]
    - [[English Wikipedia.md|English Wikipedia]]
