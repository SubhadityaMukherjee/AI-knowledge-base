...
- [Adversarial_Learning](Adversarial_Learning.md)
...
- These metrics are computed by comparing a [Normalized_Inverted_Structural_Similarity_Index](Normalized_Inverted_Structural_Similarity_Index.md) (NISSIM) metric of the Grad-CAM generated heatmap for samples from the original test set and samples from the adversarial test set.
...
## New Metrics
- [Normalized_Inverted_Structural_Similarity_Index](Normalized_Inverted_Structural_Similarity_Index.md)
- [Mean_Observed_Dissimilarity](Mean_Observed_Dissimilarity.md)
- [Variation_in_Dissimilarity_Variation_in_Dissimilarity](Variation_in_Dissimilarity_Variation_in_Dissimilarity.md)
