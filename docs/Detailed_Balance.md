...
# Detailed Balance
- To find a transition kernel T(x|y) for a homogenous, [Ergodic](Ergodic.md) [Markov_Chain](Markov_Chain.md)
...
- If T(x|y) has detailed balance wrt g, then it is an [Invariant_Distribution](Invariant_Distribution.md)
