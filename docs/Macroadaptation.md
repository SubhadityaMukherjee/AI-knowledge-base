...
- For each task that the tutoring system can assign, it knows which knowledge components are exercised by the task. For each [Knowledge_Component](Knowledge_Component.md), the tutor maintains an estimate of the student's degree of mastery of that [Knowledge_Component](Knowledge_Component.md)
