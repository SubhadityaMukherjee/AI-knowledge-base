...
- probabilistic [contrastive loss](Contrastive_Loss.md) based on NCE, which both the encoder and autoregressive model are trained to jointly optimize, which they call InfoNCE
