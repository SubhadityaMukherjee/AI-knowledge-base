...
- Using MDVM adds an [[Unsupervised Learning|unsupervised learning]] component to MBL Hoste (2005) because essentially it clusters feature values and uses that information
...
- Input cues that activate many different outcomes give rise to a highly diverse activation vector, which in turn indicates a high degree of [[Uncertainty|uncertainty]] about the intended outcome.
