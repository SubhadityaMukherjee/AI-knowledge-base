...
## [Entropy](Entropy.qmd)
- $\alpha$ determines [entropy](Entropy.qmd)
- If it is 0, and [Uniform Distribution](Uniform%20Distribution.qmd) and limit to infinity -> binary vector which is 0 everywhere except at position i when y is maximal
