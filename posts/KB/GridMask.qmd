...
- The algorithm tries to overcome drawbacks of [Cutout], [Random Erasing], and [Hide and Seek](Cutout], [Random Erasing], and [Hide and Seek.qmd) that are prone to deleting important information entirely or leaving it untouched without making it harder for the algorithm to learn.
